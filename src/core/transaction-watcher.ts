...
export class TransactionWatcher {
  ...
  constructor(
    ...
    this.patienceMilliseconds =
      options.patienceMilliseconds || TransactionWatcher.DefaultPatience;
  }
  ...
  public async awaitPending(
    ...
    const isPending = (transaction: ITransactionOnNetwork) =>
  ...
  public async awaitAnyEvent(
    ...
    const foundAnyEvent = (transactionOnNetwork: ITransactionOnNetwork) => {
      ...
      const anyIsFound =
        events.find((event) => allEventIdentifiers.includes(event)) !=
        undefined;
      return anyIsFound;
    };
  ...
  private transactionOrTxHashToTxHash(
    ...
    const hash =
      typeof transactionOrTxHash === 'string'
        ? transactionOrTxHash
        : transactionOrTxHash.getHash().hex();
  ...
  protected getAllTransactionEvents(
